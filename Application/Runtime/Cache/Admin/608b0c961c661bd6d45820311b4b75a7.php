...
<div class="container-fluid">
  <div class="row">
	...
	<form role="form" id="newGood" action="<?php echo U('Goods/edit');?>" method="post" >
       <h3><center>修改的商品</center></h3>
        <div class="form-group">			
			<input type="hidden" class="form-control" name="id" id="id" placeholder="商品id" value="<?php echo ($good_info["id"]); ?>">
		</div>
		<div class="form-group">
			<label>商品名称</label>			
			<input type="text" class="form-control" name="title" id="title" placeholder="商品名称" value="<?php echo ($good_info["title"]); ?>">
		</div>
		<div class="form-group">
		  <label>商品进货价</label>
		  <div class="input-group">			    			
			<div class="input-group-addon">￥</div>
			<input type="text" class="form-control" name="inPrice" id="inPrice" placeholder="商品进货价" value="<?php echo ($good_info["inPrice"]); ?>">
		  </div>
		</div>
		<div class="form-group">
		   <label>商品售价</label>	
		   <div class="input-group">	    			
			<div class="input-group-addon">￥</div>
			<input type="text" class="form-control" name="outPrice" id="outPrice" placeholder="商品售价" value="<?php echo ($good_info["outPrice"]); ?>">
		  </div>
		</div>
		<div class="form-group">
			<label>商品存货量</label>	
			<input type="text" class="form-control" name="remain" id="remain" placeholder="商品存货量" value="<?php echo ($good_info["remain"]); ?>">
		</div>
		<div class="form-group">
		  <label class="radio-inline">
			<input type="radio" name="isOnSale" id="isOnsale" value="<?php echo ($good_info["status"]); ?>">上架
		  </label>
		  <label class="radio-inline">
			<input type="radio" name="isOnSale" id="isOnsale" value="<?php echo ($good_info["status"]); ?>">下架
		  </label>
	    </div>
